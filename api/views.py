...
class RandomCats(APIView):
    def get(self, request):
        response = requests.get('https://api.thecatapi.com/v1/images/search?limit=18&has_breeds=1&abys&', headers={'x-api-key': 'live_yEibOC2MWOazRnaBlDfAPyWIxZmtUnQutCIcrlfCdESCaVTVs4ZPrijW7rRASmsa'})
